...
<head>
    ...
    @if($seoKeywords)
    <meta name="keywords" content="{{ $seoKeywords }}">@endif
    ...
    @if($seoOgImage)
    <meta property="og:image" content="{{ url($seoOgImage) }}">@endif
    <meta name="twitter:card" content="summary_large_image">
    @if($seofavicon)
    <link rel="icon" href="{{ $seofavicon }}">@endif
    ...
    <style>
        ...
        *::after {
        ...
        .anim-fade-left {
            animation: fadeInLeft .7s ease-out both
        }

        .anim-fade-right {
            animation: fadeInRight .7s ease-out both
        }
        ...
        .hero-bg {
            background: linear-gradient(135deg, #0a1628 0%, #1e3a5f 60%, #0a2a4a 100%);
        ...
        .btn-lift:hover {
            ...
            box-shadow: 0 8px 25px rgba(230, 126, 34, .45)
        }
        ...
        .process-step::after {
            ...
            width: calc(100% - 80px);
            height: 2px;
            background: linear-gradient(90deg, #e67e22, rgba(230, 126, 34, .2))
        }
        ...
        .process-step:hover .step-number {
            ...
            box-shadow: 0 8px 25px rgba(230, 126, 34, .5)
        }
        ...
        .text-shimmer {
            background: linear-gradient(90deg, #e67e22 0%, #f39c12 30%, #fff 50%, #f39c12 70%, #e67e22 100%);
        ...
        function animateCounter(el) {
            ...
            const ti = setInterval(() => {
                ...
                if (c >= t) {
                    el.textContent = t + s;
                    clearInterval(ti);
                } else el.textContent = Math.floor(c) + s;
            }, 16);
        }
