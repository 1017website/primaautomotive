...
<section id="services" class="relative py-20 bg-white overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16 reveal">
            <span class="inline-block px-4 py-2 bg-[#e67e22]/10 text-[#e67e22] font-semibold rounded-full text-sm mb-4">Keahlian Kami</span>
            <h2 class="text-3xl md:text-4xl font-extrabold text-[#0a1628]">Perbaikan & Perawatan Kendaraan</h2>
        </div>
        ...
        <div class="grid lg:grid-cols-2 gap-8">
            ...
            <div class="service-card rounded-2xl border-0 shadow-xl overflow-hidden bg-white {{ $i % 2 === 0 ? 'reveal-left' : 'reveal-right' }}" data-delay="{{ $i * 150 }}">
                ...
                <div class="p-8">
                    @if($service->badge)
                    <span class="inline-block px-3 py-1 bg-gray-100 text-gray-600 text-sm font-semibold rounded-full mb-3">{{ $service->badge }}</span>
                    @endif
        ...
        <div class="mt-12 reveal">
            <div class="bg-gradient-to-r from-[#0a1628] to-[#1e3a5f] rounded-2xl p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-6">
                <div>
                    <h3 class="text-xl md:text-2xl font-bold text-white mb-2">Tidak yakin layanan mana yang tepat?</h3>
                    <p class="text-gray-300">Konsultasi gratis dengan teknisi kami. Tanpa biaya, tanpa komitmen.</p>
                </div>
