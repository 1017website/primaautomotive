        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="anim-fade-left">
                ...
                <div class="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/15 rounded-full px-4 py-2 mb-6 anim-fade-up delay-100">
                    ...
                    <span class="text-sm font-medium text-gray-200">Bengkel Resmi Surabaya · Buka Sekarang</span>
                </div>
                ...
                <div class="grid grid-cols-2 gap-3 mb-10 max-w-md anim-fade-up delay-400">
                    <div class="stats-card rounded-xl p-4 text-center">
                        ...
                        <div class="text-xs text-gray-300 mt-1">Perbaikan Selesai</div>
                    </div>
                    <div class="stats-card rounded-xl p-4 text-center">
                        <div class="text-2xl font-extrabold text-primary">6-24<span class="text-sm">Bln</span></div>
                        <div class="text-xs text-gray-300 mt-1">Garansi Cat</div>
                    </div>
                    <div class="stats-card rounded-xl p-4 text-center">
                        ...
                        <div class="text-xs text-gray-300 mt-1">Rating Google</div>
                    </div>
                    <div class="stats-card rounded-xl p-4 text-center">
                        <div class="flex items-center justify-center gap-1">
                        ...
                        <div class="text-xs text-gray-300 mt-1">Pelanggan Puas</div>
                    </div>
                </div>
            ...
            <div id="tracking" class="anim-fade-right delay-300">
                <div class="tracking-card p-8">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-gray-800">Cek Status Perbaikan</h3>
                            <p class="text-sm text-gray-500">Real-time progress tracking</p>
                        </div>
                    </div>

                    <p class="text-gray-600 mb-6">Masukkan ID booking untuk melihat progress perbaikan kendaraan Anda.</p>

                    <form id="tracking-form" class="space-y-4" onsubmit="handleTracking(event)">
                        <div class="relative">
                            <input type="text"
                                   id="booking-id"
                                   placeholder="Contoh: PA-Toyota-2024-001"
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-100">
                        <p class="text-xs text-gray-400 text-center mb-3">Butuh bantuan?</p>
