...
class SiteScriptSeeder extends Seeder
{
    public function run(): void
    {
        $scripts = [
            ...
            // ELFSIGHT
            // Elfsight loader goes to HEAD (shared across all widgets)
            // Widget div goes to specific sections via embed code
            ['key' => 'elfsight_loader',   'label' => 'Elfsight — Script Loader (wajib diisi jika pakai widget Elfsight apapun)',
                'code' => '<!-- Paste script loader Elfsight di sini, contoh: <script src="https://static.elfsight.com/platform/platform.js" async></script> -->',
                'is_active' => false, 'position' => 'head', 'group' => 'embed'],
            ['key' => 'elfsight_google_reviews', 'label' => 'Elfsight — Google Reviews Widget (div embed code saja, tampil di section Ulasan)',
                'code' => null, 'is_active' => false, 'position' => 'inline', 'group' => 'embed'],
            ['key' => 'elfsight_instagram', 'label' => 'Elfsight — Instagram Feed Widget (div embed code saja, tampil di section Instagram)',
                'code' => null, 'is_active' => false, 'position' => 'inline', 'group' => 'embed'],
            ['key' => 'elfsight_whatsapp', 'label' => 'Elfsight — WhatsApp Chat Button (tampil di semua halaman, floating)',
                'code' => null, 'is_active' => false, 'position' => 'body_end', 'group' => 'embed'],
            // CUSTOM
